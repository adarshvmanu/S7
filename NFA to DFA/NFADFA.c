...
void main()
{
    ...
    printf("\nEnter No of Alphabets and Then The Alphabets : \n");
    scanf("%d", &noalpha);
    getchar();
    for (i = 0; i < noalpha; i++)
    {
    ...
    printf("NOTE:- [Transition Should Be of The Form : qno alphabet qno]\n");
...
8
NOTE:- [Transition Should Be of The Form : qno alphabet qno]
